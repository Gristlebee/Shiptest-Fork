...
/obj/item/mecha_parts/mecha_equipment/weapon/proc/melee_action(atom/target, params)
	return FALSE
...
/obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma/melee_action(atom/target)
	if(!action_checks(target))
		return
	if(isliving(target))
...
/obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma/tool_start_check(user, amount)
	if(!chassis.stopped)
		occupant_message("[src] begins cutting, locking in place!")
	chassis.stopped++
	return TRUE

/obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma/proc/saw_mob(mob/living/target, mob/user)
...
// /obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma/attach()
// 	..()
// 	toolspeed = 0.3
// 	return

// /obj/item/mecha_parts/mecha_equipment/weapon/energy/plasma/detach()
// 	..()
